namespace LibPacketGremlinTests.Packets
{
    ...
    public class ARPTests
    {
        ...
        public void ParsesBasicFields()
        {
            ...
            ARP packet;
            var parseResult = ARP.TryParse(rawBytes, out packet);
        ...
        {
            ARP packet;
            ARP.TryParse(new byte[] { 0x00, 0x01, 0x08, 0x00, 0x06, 0x04, 0x00, 0x01, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0xc0, 0xa8, 0x01, 0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xc0, 0xa8, 0x01, 0x01 }, out packet).Should().BeTrue();
