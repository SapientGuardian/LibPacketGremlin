namespace LibPacketGremlinTests.Packets
{
    ...
    public class ICMPTests
    {
        ...
        public void ParsesBasicFields()
        {
            ...
            ICMP packet;
            var parseResult = ICMP.TryParse(rawBytes, out packet);
        ...
        {
            ICMP packet;
            ICMP.TryParse(new byte[] { 0x08, 0x00, 0x4d, 0x59, 0x00, 0x01, 0x00, 0x02, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69 }, out packet).Should().BeTrue();
