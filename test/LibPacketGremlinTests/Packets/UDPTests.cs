namespace LibPacketGremlinTests.Packets
{
    ...
    public class UDPTests
    {
        ...
        [Fact]
        public void ParsesDNSQueryPayload()
        {
            byte[] rawBytes = { 0xeb, 0xf5, 0x00, 0x35, 0x00, 0x2a, 0x87, 0xf2,
  ...
  0x00, 0x01
            ...
            (packet is UDP<DNSQuery>).Should().BeTrue();

        }

        [Fact]
        public void ParsesDNSReplyPayload()
        {
            byte[] rawBytes = { 0x00, 0x35, 0xeb, 0xf5, 0x00, 0x3a, 0x6a, 0xc4,
  ...
  0x21, 0x33
            ...
            (packet is UDP<DNSReply>).Should().BeTrue();
